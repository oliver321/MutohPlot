...
<button id="check">Datei prüfen und anzeigen</button><details><summary>Kalibrierung vorbereiten</summary><label>Hard-Clip-Modus</label><select id="calwindow"><option value="norm">Norm</option><option value="exp">Exp</option><option value="type1">Type 1</option><option value="type3">Type 3</option></select><button id="calibrate">Kalibrierungszeichnung erzeugen</button><small>Verwendet Papierformat, Sicherheitsrand und Stiftprofil von oben.</small><h3>Gemessene Abstände</h3><div class="plot-info"><div><label for="caltop">Oben mm</label><input id="caltop" type="number" min="0" step="0.1"></div><div><label for="calbottom">Unten mm</label><input id="calbottom" type="number" min="0" step="0.1"></div><div><label for="calleft">Links mm</label><input id="calleft" type="number" min="0" step="0.1"></div><div><label for="calright">Rechts mm</label><input id="calright" type="number" min="0" step="0.1"></div></div><button id="calcalculate">Messwerte berechnen</button><div id="calresult" class="status">Noch keine Messwerte berechnet</div></details><hr><label>Serielle Schnittstelle</label><select id="port"><option value="">Keine gefunden</option></select>
