...
def test_writer_uses_device_resolution():
    doc = PlotDocument([Polyline([Point(0.0, 0.0), Point(1.0, 2.0)], 1)])
    text = HPGLWriter(MutohXP500(unit_mm=0.01)).write(doc)
    assert "PD100,200;" in text
